...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 23, 2025 lúc 09:31 PM
...
(1, 'Kiến thức và kinh nghiệm', 'kien-thuc-va-kinh-nghiem-1', 3, '2025-07-20 20:53:45', '2025-07-20 20:53:45');
...
(1, 1, 'Tống Hoàn Tâm', 'Giáo viên Việt Nam', 'Chứng chỉ TESOL, IELTS 8.0+, Sit odio blanditiis.', '/userfiles/images/R5AT4140.jpg', 'tong-hoan-tam-1', 'https://facebook.com/auenglish', 'chu.kiem@example.net', '<h3>Kinh nghiệm giảng dạy</h3><p>Với hơn 5 năm kinh nghiệm giảng dạy, thầy/cô đã giúp đỡ hàng trăm học viên cải thiện trình độ tiếng Anh và đạt được mục tiêu học tập. Phương pháp giảng dạy tập trung vào sự tương tác và truyền cảm hứng cho học viên.</p>', '2025-07-20 20:53:45', '2025-07-20 20:53:45'),
(2, 2, 'Chị. Mẫn Dương', 'Giáo viên Việt Nam', 'Chứng chỉ TESOL, IELTS 8.0+, Officia et harum ipsum.', '/userfiles/images/R5AT4145.jpg', 'chi-man-duong-2', 'https://facebook.com/auenglish', 'nghia.khau@example.org', '<h3>Kinh nghiệm giảng dạy</h3><p>Với hơn 5 năm kinh nghiệm giảng dạy, thầy/cô đã giúp đỡ hàng trăm học viên cải thiện trình độ tiếng Anh và đạt được mục tiêu học tập. Phương pháp giảng dạy tập trung vào sự tương tác và truyền cảm hứng cho học viên.</p>', '2025-07-20 20:53:45', '2025-07-20 20:53:45'),
(3, 3, 'Giả Tuệ Ái', 'Giáo viên Việt Nam', 'Chứng chỉ TESOL, IELTS 8.0+, Nihil et ab.', '/userfiles/images/R5AT4153.jpg', 'gia-tue-ai-3', 'https://facebook.com/auenglish', 'thy68@example.org', '<h3>Kinh nghiệm giảng dạy</h3><p>Với hơn 5 năm kinh nghiệm giảng dạy, thầy/cô đã giúp đỡ hàng trăm học viên cải thiện trình độ tiếng Anh và đạt được mục tiêu học tập. Phương pháp giảng dạy tập trung vào sự tương tác và truyền cảm hứng cho học viên.</p>', '2025-07-20 20:53:45', '2025-07-20 20:53:45');
...
CREATE TABLE `trainings` (
  ...
  `youtube_review_link` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
