    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'password' => Hash::make('password'), // Mật khẩu mặc định là 'password', bạn có thể thay đổi
        ...
        DB::table('contact')->insert([
            [
                ...
                'updated_at' => '2025-08-04 10:28:35',
            ],
        ]);
        ...
        DB::table('home_page')->insert([
            [
                ...
                'created_at' => '2025-08-04 01:54:47',
                'updated_at' => '2025-08-04 10:17:36',
            ],
        ]);
        ...
        DB::table('news')->insert([
            ...
            [
                'id' => 6,
                'slug' => 'dua-con-den-hoc-tai-trung-tam-phu-huynh-can-lam-gi-de-khong-tien-mat-tat-mang-6',
                'title' => 'Đưa con đến học tại trung tâm: Phụ huynh cần làm gì để không "tiền mất tật mang"? - 3',
                'excerpt' => 'Giữa bối cảnh thị trường trung tâm Anh ngữ đầy biến động với nhiều vụ việc "lùm xùm", việc lựa chọn một nơi học tập uy tín cho con trở thành bài toán khó. Trước khi đặt bút ký vào hợp đồng và đóng những khoản tiền lớn, phụ huynh cần trang bị kiến thức, trở thành người tiêu dùng thông thái để bảo vệ quyền lợi của chính mình và đảm bảo tương lai học tập của con.',
                'thumbnail' => '/userfiles/images/R5AT4032.jpg',
                'author' => 'Admin',
                'view' => 0,
            ...
            [
                'id' => 7,
                'slug' => 'dua-con-den-hoc-tai-trung-tam-phu-huynh-can-lam-gi-de-khong-tien-mat-tat-mang-7',
                'title' => 'Đưa con đến học tại trung tâm: Phụ huynh cần làm gì để không "tiền mất tật mang"? - 4',
                'excerpt' => 'Giữa bối cảnh thị trường trung tâm Anh ngữ đầy biến động với nhiều vụ việc "lùm xùm", việc lựa chọn một nơi học tập uy tín cho con trở thành bài toán khó. Trước khi đặt bút ký vào hợp đồng và đóng những khoản tiền lớn, phụ huynh cần trang bị kiến thức, trở thành người tiêu dùng thông thái để bảo vệ quyền lợi của chính mình và đảm bảo tương lai học tập của con.',
                'thumbnail' => '/userfiles/images/R5AT4032.jpg',
                'author' => 'Admin',
                'view' => 0,
            ...
            [
                'id' => 8,
                'slug' => 'dua-con-den-hoc-tai-trung-tam-phu-huynh-can-lam-gi-de-khong-tien-mat-tat-mang-8',
                'title' => 'Đưa con đến học tại trung tâm: Phụ huynh cần làm gì để không "tiền mất tật mang"? - 5',
                'excerpt' => 'Giữa bối cảnh thị trường trung tâm Anh ngữ đầy biến động với nhiều vụ việc "lùm xùm", việc lựa chọn một nơi học tập uy tín cho con trở thành bài toán khó. Trước khi đặt bút ký vào hợp đồng và đóng những khoản tiền lớn, phụ huynh cần trang bị kiến thức, trở thành người tiêu dùng thông thái để bảo vệ quyền lợi của chính mình và đảm bảo tương lai học tập của con.',
                'thumbnail' => '/userfiles/images/R5AT4032.jpg',
                'author' => 'Admin',
                'view' => 0,
            ...
            [
                'id' => 9,
                'slug' => 'dua-con-den-hoc-tai-trung-tam-phu-huynh-can-lam-gi-de-khong-tien-mat-tat-mang-9',
                'title' => 'Đưa con đến học tại trung tâm: Phụ huynh cần làm gì để không "tiền mất tật mang"? - 6',
                'excerpt' => 'Giữa bối cảnh thị trường trung tâm Anh ngữ đầy biến động với nhiều vụ việc "lùm xùm", việc lựa chọn một nơi học tập uy tín cho con trở thành bài toán khó. Trước khi đặt bút ký vào hợp đồng và đóng những khoản tiền lớn, phụ huynh cần trang bị kiến thức, trở thành người tiêu dùng thông thái để bảo vệ quyền lợi của chính mình và đảm bảo tương lai học tập của con.',
                'thumbnail' => '/userfiles/images/R5AT4032.jpg',
                'author' => 'Admin',
                'view' => 0,
            ...
            [
                'id' => 10,
                'slug' => 'bi-quyet-giup-con-hoc-tieng-anh-tai-nha-10',
                'title' => 'Bí quyết giúp con học tiếng Anh tại nhà 2',
                'excerpt' => 'Khen ngợi và động viên là liều thuốc tinh thần vô giá. Thay vì chỉ trích lỗi sai, hãy tập trung vào những nỗ lực và tiến bộ của con, dù là nhỏ nhất. Sự công nhận từ cha mẹ sẽ giúp con xây dựng sự tự tin và không sợ mắc lỗi khi học một ngôn ngữ mới.',
                'thumbnail' => '/userfiles/images/R5AT3841.jpg',
                'author' => 'Admin',
                'view' => 1456,
            ...
            [
                'id' => 11,
                'slug' => 'bi-quyet-giup-con-hoc-tieng-anh-tai-nha-11',
                'title' => 'Bí quyết giúp con học tiếng Anh tại nhà 3',
                'excerpt' => 'Khen ngợi và động viên là liều thuốc tinh thần vô giá. Thay vì chỉ trích lỗi sai, hãy tập trung vào những nỗ lực và tiến bộ của con, dù là nhỏ nhất. Sự công nhận từ cha mẹ sẽ giúp con xây dựng sự tự tin và không sợ mắc lỗi khi học một ngôn ngữ mới.',
                'thumbnail' => '/userfiles/images/R5AT3841.jpg',
                'author' => 'Admin',
                'view' => 1456,
            ...
            [
                'id' => 12,
                'slug' => 'bi-quyet-giup-con-hoc-tieng-anh-tai-nha-12',
                'title' => 'Bí quyết giúp con học tiếng Anh tại nhà 4',
                'excerpt' => 'Khen ngợi và động viên là liều thuốc tinh thần vô giá. Thay vì chỉ trích lỗi sai, hãy tập trung vào những nỗ lực và tiến bộ của con, dù là nhỏ nhất. Sự công nhận từ cha mẹ sẽ giúp con xây dựng sự tự tin và không sợ mắc lỗi khi học một ngôn ngữ mới.',
                'thumbnail' => '/userfiles/images/R5AT3841.jpg',
                'author' => 'Admin',
                'view' => 1456,
            ...
            [
                'id' => 13,
                'slug' => 'bi-quyet-giup-con-hoc-tieng-anh-tai-nha-13',
                'title' => 'Bí quyết giúp con học tiếng Anh tại nhà 5',
                'excerpt' => 'Khen ngợi và động viên là liều thuốc tinh thần vô giá. Thay vì chỉ trích lỗi sai, hãy tập trung vào những nỗ lực và tiến bộ của con, dù là nhỏ nhất. Sự công nhận từ cha mẹ sẽ giúp con xây dựng sự tự tin và không sợ mắc lỗi khi học một ngôn ngữ mới.',
                'thumbnail' => '/userfiles/images/R5AT3841.jpg',
                'author' => 'Admin',
                'view' => 1456,
        ...
        DB::table('trainings')->insert([
            [
                ...
                'created_at' => '2025-07-21 03:53:45',
                'updated_at' => '2025-08-04 09:13:33'
            ],
            [
                'id' => 2,
                'priority' => 2,
                ...
                'created_at' => '2025-07-21 03:53:45',
                'updated_at' => '2025-08-04 09:22:11'
            ],
            [
                'id' => 3,
                'priority' => 3,
                ...
                'created_at' => '2025-07-21 03:53:45',
                'updated_at' => '2025-08-04 09:25:21'
            ],
            [
                'id' => 4,
                'priority' => 4,
                'slug' => 'chuong-trinh-ban-tru-he-4',
                'title' => 'Chương trình Bán Trú hè',
                'age' => '3 - 13 tuổi',
                ...
                'created_at' => '2025-08-04 09:38:32',
                'updated_at' => '2025-08-04 09:40:36'
            ],
            [
                'id' => 5,
                'priority' => 5,
                'slug' => 'tieng-anh-doanh-nghiep-5',
                ...
                'youtube_review_link' => '',
                'created_at' => '2025-08-04 09:49:35',
                'updated_at' => '2025-08-04 09:56:32'
            ]
        ]);

        // Truncate other tables that are empty in the dump
