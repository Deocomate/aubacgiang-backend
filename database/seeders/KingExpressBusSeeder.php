    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'password' => Hash::make('password'), // Replace with a secure password or use the hashed one from SQL if needed
        ...
        DB::table('trainings')->insert([
            [
                ...
                'curriculum' => '[]',
                'youtube_review_link' => 'https://youtu.be/fXXcJJENN9U',
                'created_at' => '2025-07-21 03:53:45',
        ...
        DB::table('menus')->insert([
            ['id' => 1, 'name' => 'Trang chủ', 'url' => null, 'priority' => 1, 'parent_id' => null, 'created_at' => '2025-07-27 14:07:40', 'updated_at' => '2025-07-27 14:07:40'],
            ['id' => 2, 'name' => 'Tin tức & Sự kiện', 'url' => 'news', 'priority' => 2, 'parent_id' => null, 'created_at' => '2025-07-27 14:09:34', 'updated_at' => '2025-07-27 14:23:02'],
            ['id' => 3, 'name' => 'Chương trình học', 'url' => 'training', 'priority' => 3, 'parent_id' => null, 'created_at' => '2025-07-27 14:10:00', 'updated_at' => '2025-07-27 14:23:09'],
            ...
            ['id' => 7, 'name' => 'Tiếng Anh Mẫu giáo', 'url' => 'tieng-anh-mau-giao-3-6-tuoi-1', 'priority' => 1, 'parent_id' => 3, 'created_at' => '2025-07-27 14:23:40', 'updated_at' => '2025-07-27 14:23:40'],
            ['id' => 8, 'name' => 'Tiếng Anh Tiểu học', 'url' => 'tieng-anh-tieu-hoc-6-11-tuoi-2', 'priority' => 2, 'parent_id' => 3, 'created_at' => '2025-07-27 14:25:13', 'updated_at' => '2025-07-27 14:25:13'],
            ['id' => 9, 'name' => 'Tiếng Anh THCS', 'url' => 'tieng-anh-thcs-11-13-tuoi-3', 'priority' => 3, 'parent_id' => 3, 'created_at' => '2025-07-27 14:25:36', 'updated_at' => '2025-07-27 14:25:36'],
            ['id' => 10, 'name' => 'Kiến thức và kinh nghiệm', 'url' => 'kien-thuc-va-kinh-nghiem-1', 'priority' => 1, 'parent_id' => 2, 'created_at' => '2025-07-27 14:26:06', 'updated_at' => '2025-07-27 14:26:06'],
        ]);
